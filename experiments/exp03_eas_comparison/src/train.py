...
def train(args):
    ...
    # 使用预定义的数据划分
    print(f"\n{'='*50}")
    print(f"Training EAS with paper settings")
    print(f"{'='*50}")
    ...
    output_path = Path(args.output_dir) / f'eas_{args.task}_results.json'
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train EAS on CMU-MOSI')
